    ...
    <section className='platform-container'>
        <div className="platform">
            <div className="platform-image">
                <img src="/domestic-violence/assets/Image-platform.png" alt="platform-image" />
            </div>
                ...
                <div className="platform-topic">
                    ...
                    <div className="platform-text">
                        <div className="logo-topic">
                            <img src="/domestic-violence/assets/get-help.svg" alt="" />
                            <h5>Get Help</h5>
                        </div>
                    ...
                    <div className="platform-text">
                        <div className="logo-topic">
                            <img src="/domestic-violence/assets/hugeicons_energy.svg" alt="" />
                    ...
                    <div className="platform-text">
                        <div className="logo-topic">
                            <img src="/domestic-violence/assets/fluent_person-support-28-regular.svg" alt="" />
                    ...
                    <div className="platform-text">
                        <div className="logo-topic">
                            <img src="/domestic-violence/assets/hugeicons_security-wifi.svg" alt="" />
